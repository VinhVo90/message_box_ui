...
class EdgeMenu {
    ...
    $.contextMenu({
      ...
      build: () => ({
        ...
        items: {
          ...
          lineStyle: {
            type: 'select',
            options: { STRAIGHT: 'Straight', POLYLINES: 'PolyLines' },
            events: {
              change: this.onLineStyleChanged(this),
            },
            disabled: !checkModePermission(this.viewMode.value, 'editLineStyle'),
          },
          lineType: {
            type: 'select',
          ...
          removeEdge: {
            name: 'Delete',
            icon: 'fa-times',
            disabled: !checkModePermission(this.viewMode.value, 'deleteEdge')
          },
        },
        events: {
          show: (opt) => {
  ...
  onLineStyleChanged(main) {
    return function () {
      main.selectedEdge.setLineStyle(this.value);
    };
  }
